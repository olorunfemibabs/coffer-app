...
const Createfolder = () => {
  return (
    <div className="w-[350px] lgDesktop:w-[300px] lgDesktop:h-[250px] h-[280px] smDesktop:w-[217px] smDesktop:h-[200px] tabletAir:w-[245px] tablet:w-[208px] tablet:h-[190px] mobile:w-[144px] border-[#C5CBFD] rounded-2xl border-[1px] mt-[20px] mobile:h-[120px] ">
