...
const Card = (props) => {
  return (
    <div className="w-[370px] h-[280px] rounded-[16px] bg-[#C5CBFD] mt-[20px] mx-auto">
            <div className="flex">
            ...
            <div className='flex w-[342px] mx-auto justify-between h-[46px] mt-[15px] px-[10px] border-l border-l-[#010101]'>
                <h1 className="side w-[103px] text-center my-[10px] h-[46px] text-[#010101] font-[500] text-[17px] ">{props.photoNumber} Photos</h1>
